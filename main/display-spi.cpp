...
DisplayModuleSPI::DisplayModuleSPI(Config& config_in, Log &log_in, Util& util_in, SPI& spi, int module_index, int x_size_in, int y_size_in, bool flip_in, bool invert_in, bool rotate_in)
	:
		DisplayModule(config_in, log_in, util_in, x_size_in, y_size_in, flip_in, invert_in, rotate_in),
